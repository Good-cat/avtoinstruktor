...
namespace ContactsBundle\Admin;
...
//                    ->add('address', null, array('label' => 'Адрес', 'attr'=>array('class' => 'tinymce')))
//                    ->add('information', null, array('label' => 'Информация', 'attr'=>array('class' => 'tinymce')))
